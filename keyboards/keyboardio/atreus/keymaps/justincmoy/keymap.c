...
,
  ...
  [MOUSE] = LAYOUT_miryoku(
    RESET,   U_NA,    U_NA,    U_NA,    U_NA,    U_NU,    KC_BTN4, KC_BTN5, U_NU,    U_NU,
...
[GAME] = LAYOUT_miryoku(
    ...
    KC_V,      KC_Q, KC_W, KC_E,   KC_R,   KC_T,   KC_Y,    KC_U,   KC_I, KC_O,
    KC_LSHIFT, KC_A, KC_S, KC_D,   KC_F,   KC_G,   KC_H,    KC_J,   KC_K, KC_L,
    KC_Z,      KC_X, KC_C, KC_SPC, KC_TAB, KC_ENT, KC_BSPC, KC_DEL, U_NP, U_NP
)
};
